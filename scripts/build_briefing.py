...
def spine():
    ...
    # Printed here so data-smoke.yml's WEEKLY run exercises this leg from a GitHub runner too.
    # A ticker that fails closed is simply missing from the list, and a silently short list is the
