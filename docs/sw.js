...
const CACHE = "briefing-shell-v18";  // v18: leveraged ETF pulse (SOXL/SPXL/TQQQ) above Markets, read after the must-knows; v17: "Health and science" section; v16: the audio no longer re-reads a story the must-knows already told; v15: "Across the country" US national news section; v14: audio reads the 10-year, the 30-year mortgage and the VIX with the reason for each, adds the Monday policy digest, and reads a story filed in both tech and world only once; v13: Owen's Alphabet Soup (lesson deck + chained audio queue); v12: mortgage tile shows a week-over-week delta in bps; v11: static policy calendar in "What's coming"; v10: policy section + mortgage tile; v9: two-index breadth cards; v8: leaner narration; v7: breadth number
