...
const CACHE = "briefing-shell-v21";  // v21: the speed chip reaches the DEVICE VOICE too — the silent utterance that unlocks speech on iOS was queued at 1x, ahead of a tail queued at the chosen rate; v20: a playback-speed chip in the Listen bar (1x/1.5x/2x, remembered, applied to the mp3 queue AND the device voice); v19: the ETF pulse becomes the WATCHLIST — any ticker (watchlist.txt), a buy/trim/hold action colouring each card, and audio that names only the buy/trim ones; v18: leveraged ETF pulse (SOXL/SPXL/TQQQ) above Markets, read after the must-knows; v17: "Health and science" section; v16: the audio no longer re-reads a story the must-knows already told; v15: "Across the country" US national news section; v14: audio reads the 10-year, the 30-year mortgage and the VIX with the reason for each, adds the Monday policy digest, and reads a story filed in both tech and world only once; v13: Owen's Alphabet Soup (lesson deck + chained audio queue); v12: mortgage tile shows a week-over-week delta in bps; v11: static policy calendar in "What's coming"; v10: policy section + mortgage tile; v9: two-index breadth cards; v8: leaner narration; v7: breadth number
